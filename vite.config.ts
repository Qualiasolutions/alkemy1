...
export default defineConfig(({ mode }) => {
  ...
  return {
    ...
    build: {
      ...
      // Use esbuild instead of terser to prevent temporal dead zone errors
      minify: 'esbuild',
      target: 'es2020',
    },
    define: {
      ...
      'process.env.FAL_API_KEY': JSON.stringify(falKey),
      ...
      'import.meta.env.FAL_API_KEY': JSON.stringify(falKey),
      'import.meta.env.VITE_FAL_API_KEY': JSON.stringify(falKey),
