                    ...
                    >
                        <h1 className={`text-6xl font-bold mb-4 ${isDark ? 'text-white' : 'text-black'}`}>
                            <span className={`bg-gradient-to-r ${
                                isDark
                                    ? 'from-[#dfec2d] via-[#dfec2d] to-[#dfec2d]'
                                    : 'from-[#b3e617] via-[#b3e617] to-[#b3e617]'
                                ...
                                >
                                    ...
                                    <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium ${
                                        isDark
                                            ...
                                            : 'bg-teal-100 text-[#b3e617] border border-teal-200'
                                    }`}>
                                        <span>Supports:</span>
                            ...
                            >
                                ...
                                <button
                                    ...
                                    className={`font-semibold ${
                                        isDark ? 'text-[#dfec2d] hover:text-[#d4ff5c]' : 'text-[#b3e617] hover:text-[#b3e617]'
