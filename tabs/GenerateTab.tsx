            ...
            <div className="border-b border-white/10 p-4 sm:p-6 bg-gradient-to-b from-white/5 to-transparent flex-shrink-0">
                <div className="flex items-center justify-between flex-wrap gap-4">
                    <div className="flex-1 min-w-0">
                        <h1 className="text-2xl sm:text-3xl font-bold mb-1 sm:mb-2 truncate">AI Media Generator</h1>
                        ...
                        {generatedMedia.length > 0 && (
                            <>
                                <button
                                    ...
                                    className="px-4 py-2 bg-[#dfec2d] text-black rounded-lg hover:bg-[#b3e617] transition-all flex items-center gap-2 font-semibold"
                                >
                ...
                >
                        ...
                        {mode === 'image' && (
                            <div>
                                ...
                                >
                                    ...
                                    <option value={6} className="bg-[#0a0a0a]">6 Images</option>
                                </select>
                            </div>
                        )}
                    </div>
                    ...
                    >
                        {isGenerating ? (
                            ...
                            <>
                                Generate {mode === 'image' && generationCount > 1 ? `${generationCount} Images` : mode === 'image' ? 'Image' : 'Video'}
                            </>
                        )}
                    </button>
                    ...
                    {isGenerating ? (
                        <div className="flex flex-col items-center justify-center h-full text-center p-4">
                            ...
                            <h3 className="text-xl font-semibold text-white mb-2">
                                Generating {mode === 'image' ? `${generationCount} image${generationCount > 1 ? 's' : ''}` : 'video'}...
                            </h3>
                            <p className="text-white/60 max-w-md break-words">{prompt.substring(0, 150)}{prompt.length > 150 ? '...' : ''}</p>
                            ...
                            <div className="overflow-x-auto pb-4 -mx-4 px-4">
                                <div className="flex gap-4 w-max">
                                    {generatedMedia.map((item) => (
                                        ...
                                        >
                                            {item.type === 'image' ? (
                                                <img src={item.url} alt={item.prompt} className="w-full aspect-video object-cover" />
                                            ) : (
                                                ...
                                                <div className="absolute bottom-0 left-0 right-0 p-3 space-y-2">
                                                    ...
                                                    <div className="flex gap-2">
                                                        <button
                                                            ...
                                                            className="flex-1 py-1.5 px-2 bg-[#dfec2d] text-black rounded text-xs font-semibold hover:bg-[#b3e617] transition-all flex items-center justify-center gap-1"
                                                        >
                        ...
                        <div className="absolute top-0 left-0 right-0 p-4 sm:p-6 bg-gradient-to-b from-black/80 to-transparent">
                            <div className="flex items-start justify-between gap-4">
                                <div className="flex-1 max-w-2xl min-w-0">
                                    ...
                                    <p className="text-white text-sm leading-relaxed break-words">{fullscreenItem.prompt}</p>
                                </div>
                                <button
                                    onClick={() => setFullscreenItem(null)}
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6 bg-gradient-to-t from-black/80 to-transparent">
                            <div className="flex items-center justify-center gap-2 sm:gap-3 flex-wrap">
                                ...
                                <button
                                    ...
                                    className="px-6 py-3 bg-[#dfec2d] text-black rounded-lg hover:bg-[#b3e617] transition-all flex items-center gap-2 font-semibold shadow-lg"
                                >
