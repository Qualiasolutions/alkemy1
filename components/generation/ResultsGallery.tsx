...
const ResultsGallery: React.FC<ResultsGalleryProps> = ({
    ...
    if (items.length === 0) {
        return (
            ...
            >
                ...
                >
                    <svg width="64" height="64" viewBox="0 0 24 24" fill="none" stroke={colors.text_tertiary} strokeWidth="2">
    ...
    return (
        <>
            <div className={`${layout === 'grid' ? `grid ${gridColumns[columns]} gap-4` : 'flex flex-col gap-4'} ${className}`}>
                {items.map((item, index) => (
                    ...
                    >
                                    ...
                                    >
                                        ...
                                        {onItemDelete && (
                                            <motion.button
                                                ...
                                                title="Delete"
                                            >
                                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#F04438" strokeWidth="2">
                        ...
                        {/* Info */}
                        <div className="p-3">
                            <h4 className="font-semibold text-sm truncate" style={{ color: colors.text_primary }}>
                                {item.title}
                            </h4>
                            {item.description && (
                        ...
                        >
                            ...
                            <div className="p-6">
                                ...
                                {selectedItem.metadata && (
                                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-4 pt-4 border-t" style={{ borderColor: colors.border_color }}>
