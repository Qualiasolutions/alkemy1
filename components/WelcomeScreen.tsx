...
const WelcomeScreen: React.FC<WelcomeScreenProps> = ({
  ...
  return (
    <section id="home" className="relative min-h-screen overflow-hidden">
      ...
      <div className="pointer-events-none absolute -top-40 left-1/4 h-96 w-96 rounded-full bg-emerald-500/20 blur-[128px] animate-pulse-soft" />
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 text-center">
        ...
        >
          {[
            {
              icon: (
                <svg className="w-7 h-7 text-emerald-400" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">
                  <path d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                </svg>
              ),
              title: 'Script Analysis',
              description: 'AI-powered script breakdown with scene detection, character analysis, and technical shot planning',
              delay: 0.9
            },
            {
              icon: (
              ...
              description: 'Generate characters, locations, and shot compositions using Imagen 3 and Flux models',
              delay: 1.0
            },
            {
              icon: (
              ...
              description: 'Transform still frames into cinematic video clips with Veo 3.1 and export to timeline',
              delay: 1.1
            }
          ].map((feature, index) => (
            <motion.div
              ...
              className="group"
            >
              <div className="glass rounded-2xl p-8 border border-[var(--color-border-color)] hover:border-emerald-500/40 transition-all duration-300 h-full relative overflow-hidden">
                {/* Gradient overlay on hover */}
                <div className="absolute inset-0 bg-gradient-to-br from-emerald-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />

                <div className="relative">
                  <motion.div
                    className="w-14 h-14 rounded-xl bg-emerald-500/10 flex items-center justify-center mb-5 group-hover:bg-emerald-500/20 transition-colors duration-300 shadow-lg shadow-emerald-500/10"
                    whileHover={{ rotate: [0, -10, 10, -10, 0], scale: 1.1 }}
                    transition={{ duration: 0.5 }}
                  >
                    {feature.icon}
                  </motion.div>
                  <h3 className="text-xl font-semibold text-[var(--color-text-primary)] mb-3 group-hover:text-emerald-400 transition-colors duration-300">
                    {feature.title}
                  </h3>
