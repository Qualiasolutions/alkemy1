    ...
    return (
        <motion.button
            ...
            className={`fixed bottom-6 right-6 z-40 group ${
                isDark
                    ? 'bg-gradient-to-br from-[#dfec2d] to-[#b3e617] text-black'
                    : 'bg-gradient-to-br from-[#dfec2d] to-[#b3e617] text-gray-900'
        ...
        >
            ...
            >
                View Full Script
                <div className={`absolute top-full right-6 w-2 h-2 transform rotate-45 ${
