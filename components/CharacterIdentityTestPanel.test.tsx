...
describe('CharacterIdentityTestPanel', () => {
  ...
  describe('Rendering States', () => {
    it('should show identity not ready message when identity is missing', () => {
      ...
      expect(screen.getByText(/Character identity must be trained before testing can begin/)).toBeInTheDocument();
    ...
    it('should show full testing interface when identity is ready', () => {
      ...
      expect(screen.getByText(`Character Identity Testing - ${mockCharacterWithIdentity.name}`)).toBeInTheDocument();
      expect(screen.getByText(/Generate test variations to validate character consistency/)).toBeInTheDocument();
  ...
  describe('Generate All Tests', () => {
    ...
    it('should display progress during generation', async () => {
      ...
      vi.mocked(characterIdentityService.generateAllTests).mockImplementation(async ({ onProgress }) => {
