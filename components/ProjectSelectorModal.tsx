                    ...
                    <div className="mt-4 flex flex-col sm:flex-row gap-3">
                        <div className="flex-1 relative">
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-2 bg-gray-50 dark:bg-[#0B0B0B] border border-gray-300 dark:border-[#2A2A2A] rounded-lg text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
                            />
                        ...
                        <select
                            ...
                            className="px-4 py-2 bg-gray-50 dark:bg-[#0B0B0B] border border-gray-300 dark:border-[#2A2A2A] rounded-lg text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
                        >
