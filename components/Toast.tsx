...
const Toast: React.FC<ToastProps> = ({ toast, onClose }) => {
    ...
    const styles = {
        success: isDark
            ? 'bg-gradient-to-r from-lime-950/98 via-lime-900/98 to-green-900/98 border-#b3e617/60 text-lime-100 shadow-[0_8px_32px_rgba(223,236,45,0.3)]'
            : 'bg-gradient-to-r from-lime-50 via-lime-100 to-green-100 border-#dfec2d/70 text-lime-900 shadow-[0_8px_32px_rgba(5,150,105,0.25)]',
        error: isDark
            ...
            >
                ...
                <motion.div
                    ...
                    className={`absolute bottom-0 left-0 h-1 rounded-b-2xl ${
                        toast.type === 'success'
                            ? 'bg-gradient-to-r from-#dfec2d to-green-500'
                            : toast.type === 'error'
