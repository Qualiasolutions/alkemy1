        ...
        >
          <div className="mb-6">
            ...
            <p style={{ color: colors.text_secondary }}>
              Your password has been successfully updated. You'll be redirected to the login page in
              a few seconds.
            </p>
          </div>
    ...
    <div className={`flex items-center justify-center min-h-screen ${colors.bg_primary}`}>
      ...
      >
        <div className="mb-8 text-center">
          ...
          <p style={{ color: colors.text_secondary }}>Enter your new password below.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input
              ...
              placeholder="••••••••"
            />
            <p className="mt-1 text-xs" style={{ color: colors.text_tertiary }}>
