        ...
        <nav className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <div className="flex items-center justify-center w-10 h-10 bg-gradient-to-br from-[#DFEC2D] to-[#FDE047] rounded-lg font-bold text-black text-xl">
                A
              </div>
              ...
              {supabaseConfigured && isAuthenticated ? (
                <>
                  <Button
                    ...
                    className="bg-[#DFEC2D] text-black hover:bg-[#FDE047] font-semibold"
                  >
                    Open Studio
                  </Button>
                  <Button
          ...
          <div className="text-center space-y-6 mt-12">
            ...
            <div className="flex gap-4 justify-center pt-4">
              <Button
                size="lg"
                onClick={handleGetStarted}
                className="bg-[#DFEC2D] text-black hover:bg-[#FDE047] font-semibold text-lg px-8 py-6 group"
              >
                Start Creating
      ...
      <section className="py-20 px-6 bg-gradient-to-b from-gray-950 to-black">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <Button
            size="lg"
            onClick={handleGetStarted}
            className="bg-[#DFEC2D] text-black hover:bg-[#FDE047] font-semibold text-lg px-10 py-6"
          >
