...
const GenerationPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen" style={{ background: colors.background_primary }}>
      ...
      <div className="pointer-events-none fixed -top-32 left-1/2 h-[520px] w-[520px] -translate-x-1/2 rounded-full bg-yellow-500/10 blur-3xl" />
      <div className="pointer-events-none fixed bottom-0 right-[-10%] h-[420px] w-[420px] rounded-full bg-yellow-400/10 blur-3xl" />
        ...
        <div className="mx-auto max-w-7xl px-6 py-5">
            ...
            <div className="flex items-center gap-4">
              ...
              >
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none">
                  <path d="M12 2L2 7L12 12L22 7L12 2Z" fill={colors.accent_primary} opacity="0.8" />
                  <path
                    d="M2 17L12 22L22 17"
          ...
          <div className="flex gap-2 mt-6">
            <button
              ...
              style={{
                background:
                  activeWorkflow === 'character' ? 'rgba(16, 163, 127, 0.15)' : colors.surface_card,
                borderWidth: '2px',
                borderStyle: 'solid',
                borderColor:
                  activeWorkflow === 'character' ? colors.accent_primary : colors.border_color,
            ...
            <button
              ...
              style={{
                background:
                  activeWorkflow === 'world' ? 'rgba(16, 163, 127, 0.15)' : colors.surface_card,
                borderWidth: '2px',
                borderStyle: 'solid',
                borderColor:
                  activeWorkflow === 'world' ? colors.accent_primary : colors.border_color,
      ...
      {/* Footer */}
      <footer className="mt-20 border-t py-8" style={{ borderColor: colors.border_color }}>
