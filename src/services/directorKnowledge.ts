...
export const DIRECTORS_DATABASE: Record<string, DirectorProfile> = {
  coppolaFrancis: {
    ...
    visualStyle: {
      composition:
        'Theatrical staging with deep focus, subjects framed in doorways/windows, Renaissance painting influence',
      lighting:
        'Warm tungsten practicals (3200K), high contrast ratios (4:1 to 8:1), chiaroscuro, motivated lighting from windows and lamps',
      colorPalette:
        'Earth tones, browns, golds, deep shadows - Italian Renaissance and Baroque painting aesthetic',
      cameraMovement:
        'Slow dolly-in on emotional beats, restrained Steadicam, deliberate pacing, static wide shots for tableaux',
      editing:
        'Long takes with methodical pacing, parallel editing for crosscutting, operatic rhythm',
    },
    technicalChoices: {
    ...
    collaborators: [
      ...
      'Walter Murch (editor/sound)',
    ],
    whenToEmulate:
      'Epic family dramas, crime sagas, operatic emotional moments, classical Hollywood aesthetic with modern sensibility',
  },
  kubrick: {
    ...
    visualStyle: {
      composition:
        'Perfect symmetry, one-point perspective, geometric precision, centered subjects, architectural framing',
      lighting:
        'Practical sources only, natural light, high ISO pushed film, minimal fill, stark contrast',
      colorPalette:
        'Desaturated with selective color pops, cool tones, clinical sterility, bold primary colors for emphasis',
      cameraMovement:
        'Slow tracking shots, steady dolly, Steadicam invention (The Shining), slow zoom-outs',
    ...
    technicalChoices: {
      ...
      filmStock:
        'Pushed 35mm for natural light, pioneered high-speed film for candlelight in Barry Lyndon',
    },
    notableWorks: [
    ...
    whenToEmulate:
      'Psychological thrillers, science fiction, symmetrical compositions, cold sterile environments, slow-burn tension',
  },
  nolan: {
    ...
    visualStyle: {
      composition:
        'Wide establishing shots, human figures dwarfed by environment, geometric architecture, layered depth',
      lighting:
        'Natural light when possible, high-key for realism, minimal color grading, preserved highlights and shadows',
      colorPalette:
        'Desaturated realism, blue-gray tones, minimal color correction, naturalistic palette',
      cameraMovement:
        'Steadicam for action, locked-off for dialogue, IMAX crane shots for spectacle, minimal handheld',
      editing:
        'Intercutting timelines, rhythmic cross-cutting, building tension through parallel action',
    },
    technicalChoices: {
    ...
    whenToEmulate:
      'Epic scale, heist films, science fiction, IMAX spectacle, realistic blockbusters, non-linear narratives',
  },
  andersonWes: {
    name: 'Wes Anderson',
    ...
    visualStyle: {
      composition:
        'Perfect bilateral symmetry, centered subjects, planimetric (parallel to camera plane), frame-within-frame, tableau staging',
      lighting: 'Soft even lighting, high-key, minimal shadows, flat lighting for storybook feel',
      colorPalette:
        'Curated pastel colors, warm analogous schemes, retro color timing, production design-driven palette',
      cameraMovement:
        'Symmetrical pans, slow lateral tracking, snap zooms, whip pans for transitions, static tableaux',
    ...
    whenToEmulate:
      'Quirky comedies, storybook narratives, symmetrical aesthetics, pastel color schemes, whimsical tone',
  },
  fincher: {
    name: 'David Fincher',
    ...
    visualStyle: {
      composition:
        'Low angles for psychological unease, geometric precision, architectural framing, negative space',
      lighting:
        'Low-key with selective highlighting, practical sources, cool color temperatures, high contrast ratios',
      colorPalette:
        'Desaturated with yellow-green cast, teal shadows, sickly fluorescent quality, controlled color palette',
      cameraMovement:
        'Smooth programmed moves, dolly and crane choreography, CG camera moves, locked tripod for tension',
      editing:
        'Rhythmic precision, metric editing, invisible cuts, controlled pacing building to crescendos',
    },
    technicalChoices: {
    ...
    whenToEmulate:
      'Psychological thrillers, crime dramas, tech-driven narratives, dark atmospheres, controlled tension',
  },
  villeneuve: {
    ...
    visualStyle: {
      composition:
        'Extreme wides with isolated figures, overhead shots, centered subjects, architectural geometry, negative space',
      lighting:
        'Naturalistic with dramatic contrast, warm practicals vs cool ambient, soft diffused daylight, motivated sources',
      colorPalette:
        'Desaturated earth tones, warm amber vs cool blue, ochre deserts, industrial grays',
      cameraMovement:
        'Slow deliberate movements, floating crane shots, locked-off wides, Steadicam for intimacy',
      editing:
        'Contemplative pacing, long takes, rhythm through visual motifs, silence as punctuation',
    },
    technicalChoices: {
    ...
    whenToEmulate:
      'Science fiction epics, slow-burn thrillers, existential narratives, vast landscapes, contemplative tone',
  },
  spielberg: {
    ...
    visualStyle: {
      composition:
        'Dynamic staging with depth, foreground/background action, subjects looking off-screen at wonder',
      lighting:
        'Soft warm lighting, golden hour magic, lens flares, backlit silhouettes, Rembrandt lighting for faces',
      colorPalette:
        'Warm nostalgic tones, golden hour amber, saturated primaries, Kodachrome aesthetic',
      cameraMovement:
        'Fluid Steadicam, dramatic push-ins, crane moves for reveals, tracking shots following action',
      editing:
        'Seamless continuity, building emotional crescendos, intercutting for tension, clear spatial geography',
    },
    technicalChoices: {
    ...
    whenToEmulate:
      'Adventure films, emotional family dramas, wonder and awe, nostalgic Americana, dynamic action',
  },
  tarantino: {
    ...
    visualStyle: {
      composition:
        'Low angles (trunk shots), symmetrical two-shots for dialogue, dynamic ensemble staging, graphic insert shots',
      lighting:
        'High-key with saturated colors, practical sources, 70s exploitation film look, warm tungsten interiors',
      colorPalette:
        'Saturated bold primaries, retro color timing, warm reds and oranges, comic book vibrancy',
      cameraMovement:
        'Crash zooms for emphasis, slow Steadicam through spaces, locked tripod for dialogue, snap whip pans',
      editing:
        'Non-linear chapter structure, rhythmic violence, music-driven montages, extended dialogue scenes',
    },
    technicalChoices: {
    ...
    whenToEmulate:
      'Genre pastiches, dialogue-driven scenes, exploitation aesthetics, non-linear narratives, stylized violence',
  },
  scorsese: {
    ...
    visualStyle: {
      composition:
        'Dynamic reframing, subjects in motion, crowded frames with layered depth, Dutch angles for unease',
      lighting:
        'Naturalistic with dramatic flair, neon practicals, nightclub lighting, warm interiors vs cool exteriors',
      colorPalette:
        'Saturated reds (violence, passion), warm tungsten interiors, neon colors, rich blacks',
      cameraMovement:
        'Virtuosic tracking shots, handheld for energy, slow-motion for balletic violence, Steadicam through spaces',
      editing:
        'Rhythmic cutting to music, freeze frames, rapid montages, kinetic energy, layered sound design',
    },
    technicalChoices: {
    ...
    collaborators: [
      ...
      'Robert Richardson (recent)',
    ],
    whenToEmulate:
      'Crime dramas, character studies, urban grit, musical energy, moral complexity, Italian-American stories',
  },
  ptanderson: {
    ...
    visualStyle: {
      composition:
        'Deep focus ensemble staging, symmetrical framing, subjects centered or at thirds, architectural precision',
      lighting:
        'Soft naturalistic lighting, window light, minimal fill, golden hour exteriors, practical interiors',
      colorPalette:
        'Warm earth tones, period-accurate colors, saturated but natural, amber sunlight',
      cameraMovement:
        "Fluid long takes, slow push-ins for emotional intensity, Steadicam through spaces, crane for God's-eye view",
      editing:
        'Long takes with dynamic staging, invisible cuts, building emotional intensity, musical rhythm',
    },
    technicalChoices: {
    ...
    whenToEmulate:
      'Character studies, period dramas, ensemble pieces, emotional intensity, methodical pacing, Altman-esque',
  },
}
...
export const CINEMATOGRAPHERS_DATABASE: Record<string, CinematographerProfile> = {
  deakinsRoger: {
    ...
    technicalExpertise: {
      lighting:
        'Master of naturalistic lighting, uses practicals and motivated sources, subtle fill, controlled shadows, soft diffused daylight',
      colorScience:
        'Restrained color palettes, desaturated with selective pops, maintains skin tones, avoids trendy grades',
      cameraWork:
        'Smooth fluid movement, Steadicam master, prefers simplicity over flash, locked-off for tension',
      specialization: [
        'Silhouettes',
        'Backlight',
    ...
    oscarWins: 2,
    visualSignature:
      'Naturalistic beauty - makes complex lighting appear effortless and invisible, favors silhouettes and controlled backlight, never calls attention to technique',
  },
  lubezekiEmmanuel: {
    ...
    technicalExpertise: {
      lighting:
        'Almost entirely natural light, golden hour specialist, minimal artificial sources, high ISO for candlelight, soft wrap-around ambience',
      colorScience:
        'Warm naturalistic tones, golden hour obsession, preserves highlights, film-like digital color, organic color timing',
      cameraWork:
        'Virtuosic long takes, floating Steadicam, wide-angle immersion, intimate handheld, pioneering wireless video village',
      specialization: [
        'Long takes',
        'Natural light',
        'Wide-angle poetry',
        'Steadicam choreography',
        'Golden hour',
      ],
    },
    notableCollaborations: [
      ...
      { director: 'Alfonso Cuarón', films: ['Gravity', 'Children of Men', 'Y Tu Mamá También'] },
      {
        ...
        films: ['The Tree of Life', 'The New World', 'To the Wonder'],
      },
    ],
    oscarWins: 3,
    visualSignature:
      'Ethereal natural light poetry - creates immersive experiences through virtuosic long takes, golden hour obsession, and floating camera movement that feels like consciousness itself',
  },
  stororoVittorio: {
    ...
    technicalExpertise: {
      lighting:
        'Operatic dramatic lighting, high contrast ratios, hard directional sources, theatrical spotlights, colored gels for symbolism',
      colorScience:
        'Color theory master, uses color symbolically, saturated primaries, theatrical color temperature shifts, pioneered digital color timing',
      cameraWork:
        'Formal composed frames, slow deliberate moves, geometric precision, classical framing, theatrical staging',
      specialization: [
        'Color symbolism',
        'Chiaroscuro',
        'Theatrical lighting',
    ...
    notableCollaborations: [
      { director: 'Francis Ford Coppola', films: ['Apocalypse Now', 'One from the Heart'] },
      {
        ...
        films: ['The Last Emperor', 'The Conformist', 'Last Tango in Paris'],
      },
      { director: 'Warren Beatty', films: ['Reds', 'Dick Tracy'] },
    ],
    oscarWins: 3,
    visualSignature:
      'Operatic color symphony - treats color as a narrative language with symbolic meaning, creates theatrical drama through high-contrast lighting and bold color choices',
  },
  kamińskiJanusz: {
    ...
    technicalExpertise: {
      lighting:
        'Strong backlight, lens flares, shafts of light, smoke and atmosphere, high contrast with blown highlights, soft faces with hard backgrounds',
      colorScience:
        'Bleach bypass pioneer, desaturated palette, preserves skin tones while crushing other colors, diffusion filters, milky blacks',
      cameraWork:
        'Fluid Steadicam, dramatic push-ins, handheld for chaos, crane for scale, dynamic reframing',
      specialization: [
        'Lens flares',
        'Bleach bypass',
    ...
    oscarWins: 2,
    visualSignature:
      'Ethereal realism - combines lens flares, diffusion, and bleach bypass to create a dreamlike quality while maintaining grounded realism, master of atmospheric lighting',
  },
  fraserGreig: {
    name: 'Greig Fraser',
    ...
    technicalExpertise: {
      lighting:
        'LED technology pioneer, natural light augmented with LEDs, large soft sources, minimal crew on location, fast reactive lighting',
      colorScience:
        'Film grain on digital, organic color timing, naturalistic skin tones, preserves texture, avoids clinical digital look',
      cameraWork:
        'IMAX specialist, immersive handheld, Steadicam fluidity, practical effects in-camera, minimal VFX reliance',
      specialization: [
        'IMAX',
        'LED lighting',
        'Natural light',
    ...
    oscarWins: 1,
    visualSignature:
      'Immersive IMAX realism - combines large format cinematography with naturalistic lighting and practical in-camera effects, creates tactile lived-in worlds',
  },
  richardsonRobert: {
    ...
    technicalExpertise: {
      lighting:
        'Adapts to each project, from high-key comedy to low-key noir, master of both controlled studio and natural location lighting',
      colorScience:
        'Versatile colorist, handles desaturated realism (Scorsese) and saturated primaries (Tarantino), black-and-white master',
      cameraWork:
        'Fluid adaptability, kinetic handheld (Stone), controlled elegance (Tarantino), classical framing (Anderson)',
      specialization: [
        'Versatility',
        'Black and white',
        'Kinetic camera',
    ...
    notableCollaborations: [
      {
        ...
        films: ['Kill Bill', 'Inglourious Basterds', 'Django Unchained', 'The Hateful Eight'],
      },
      {
        director: 'Martin Scorsese',
        films: ['The Aviator', 'Shutter Island', 'Hugo', 'Killers of the Flower Moon'],
      },
      { director: 'Oliver Stone', films: ['JFK', 'Natural Born Killers', 'Platoon'] },
    ],
    oscarWins: 3,
    visualSignature:
      "Chameleon master - ultimate collaborator who adapts style to serve each director's vision, equally comfortable with kinetic chaos and classical elegance",
  },
}
...
export const COMMERCIAL_DIRECTORS_DATABASE: Record<string, CommercialDirectorProfile> = {
  jonzeSpike: {
    ...
    visualStyle:
      'Naturalistic documentary-style camera work meets surreal conceptual ideas. Handheld energy with emotional depth. Warm color palettes with practical lighting.',
    technicalApproach:
      'Prefers naturalistic lighting and handheld camera for authenticity. Embraces imperfection and spontaneity. Wide lenses (25-35mm) for environmental context.',
  },
  gondreyMichel: {
    name: 'Michel Gondry',
    ...
    visualStyle:
      'DIY handmade aesthetic with practical effects. Bright saturated colors. Inventive camera tricks and transitions. Whimsical and childlike wonder.',
    technicalApproach:
      'In-camera effects over post-production. Creative rigging and practical magic. Standard lenses (40-50mm) for natural perspective. High-key colorful lighting.',
  },
  glazerJonathan: {
    ...
    visualStyle:
      'Cinematic drama with theatrical lighting. High contrast with deep blacks. Slow-motion beauty shots. Minimalist compositions with negative space. Moody atmospheric fog.',
    technicalApproach:
      'High-speed cameras for slow-motion (120-240fps). Low-key dramatic lighting (8:1 ratios). Portrait lenses (85-135mm) for subject isolation. Precision-timed choreography.',
  },
  fincherdavidCommercial: {
    ...
    visualStyle:
      'Dark, desaturated, and meticulously controlled. Low angles for power. Yellow-green color cast. Programmed camera moves. Clinical precision.',
    technicalApproach:
      'Programmed motion control for repeatable moves. Digital cinema for post flexibility. Wide-angle lenses (21-35mm) for dynamic perspectives. Low-key lighting with selective highlights.',
  },
  romijakChris: {
    name: 'Chris Romjak',
    ...
    visualStyle:
      'Automotive specialist with dramatic urban cinematography. Low angles and reflections. Sleek metallic surfaces. Moody atmospheric lighting. Dynamic movement.',
    technicalApproach:
      'Russian arm and pursuit vehicles for car shots. High-speed cameras (phantom) for details. Wide anamorphic lenses (24-40mm). Urban location lighting with practicals.',
  },
  meierteMarkus: {
    name: 'Markus Meiertë',
    ...
    visualStyle:
      'High-fashion editorial look with extreme beauty lighting. Saturated colors or stark black and white. Slow sensual camera movements. Macro close-ups on textures.',
    technicalApproach:
      'Beauty lighting with ring lights and soft sources. Macro lenses (100-180mm) for tactile details. Slow dolly moves. High-end digital cinema cameras for maximum resolution.',
  },
  stolenMark: {
    name: 'Mark Stolen',
    ...
    visualStyle:
      'High-energy sports and adventure aesthetic. Dynamic handheld and aerial shots. Slow-motion action highlights. Natural outdoor lighting. Gritty texture and grain.',
    technicalApproach:
      'High-speed cameras for action (240-480fps). Drones and gimbal rigs for movement. Wide-angle lenses (14-24mm) for immersion. Natural light augmented with reflectors.',
  },
  murphyAndreas: {
    ...
    visualStyle:
      'Quirky comedy with colorful production design. Symmetrical compositions inspired by Wes Anderson. Bright saturated colors. Deadpan visual humor.',
    technicalApproach:
      'Locked-off symmetrical framing. Standard lenses (40-50mm) for natural perspective. High-key even lighting for comedy. Precise production design and color coordination.',
  },
}
...
export function getDirectorByName(name: string): DirectorProfile | null {
  ...
  const entry = Object.entries(DIRECTORS_DATABASE).find(
    ([_key, profile]) =>
      profile.name
        .toLowerCase()
        .replace(/[^a-z]/g, '')
...
export function getCinematographerByName(name: string): CinematographerProfile | null {
  const normalized = name.toLowerCase().replace(/[^a-z]/g, '')
  const entry = Object.entries(CINEMATOGRAPHERS_DATABASE).find(
    ([_key, profile]) =>
      profile.name
        .toLowerCase()
        .replace(/[^a-z]/g, '')
...
export function getCommercialDirectorByName(name: string): CommercialDirectorProfile | null {
  const normalized = name.toLowerCase().replace(/[^a-z]/g, '')
  const entry = Object.entries(COMMERCIAL_DIRECTORS_DATABASE).find(
    ([_key, profile]) =>
      profile.name
        .toLowerCase()
        .replace(/[^a-z]/g, '')
...
export function calculateDepthOfField(
  ...
  const far =
    distance >= hyperfocalMeters
      ? Infinity
      : (distance * (hyperfocalMeters - focalLength / 1000)) / (hyperfocalMeters - distance)
