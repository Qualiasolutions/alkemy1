...
interface NavigationControlsProps {
    // Camera controls
    onCameraPreset: (preset: 'front' | 'back' | 'top' | 'bottom' | 'left' | 'right' | 'isometric') => void;
    // Lighting controls
                            ...
                            {[
                                ...
                                <button
                                    ...
                                    style={{
                                        ...
                                        border: 'none',
                                        borderBottom: activeTab === tab.id ? `2px solid ${colors.accent_primary}` : '2px solid transparent',
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                                    ...
                                    <div style={{
                                        ...
                                        <p style={{
                                            ...
                                            💡 <strong>Tip:</strong> Use mouse to orbit (drag), scroll to zoom, and right-click to pan.
                                        </p>
                                    </div>
                                </div>
                            )}
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => handleLightingChange('ambient', Number(e.target.value) / 100)}
                                            style={{
                                                width: '100%',
                                                cursor: 'pointer'
                                            }}
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => handleLightingChange('directional', Number(e.target.value) / 100)}
                                            style={{
                                                width: '100%',
                                                cursor: 'pointer'
                                            }}
