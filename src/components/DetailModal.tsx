...
import type { AnalyzedCharacter, AnalyzedLocation, AnalyzedScene } from '../types'
import { ClapperboardIcon, MapPinIcon, UsersIcon, XIcon } from './icons/Icons'
              ...
              <div className="flex items-start gap-3">
                <div
                  className={`flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center font-bold ${
                    isDark ? 'bg-[#DFEC2D]/20 text-[#DFEC2D]' : 'bg-[#DFEC2D]/30 text-[#FDE047]'
                  }`}
                >
                  {scene.sceneNumber}
                </div>
                  ...
                  <div className="flex flex-wrap gap-2 text-xs">
                    ...
                    {scene.frames && scene.frames.length > 0 && (
                      <span
                        className={`px-2 py-1 rounded-full ${
                          isDark
                            ? 'bg-[#DFEC2D]/20 text-[#DFEC2D]'
                            : 'bg-[#DFEC2D]/30 text-[#FDE047]'
                        }`}
                      >
        ...
        <>
          ...
          >
            ...
            >
              ...
              {/* Content */}
              <div className="p-6 overflow-y-auto max-h-[calc(90vh-80px)]">{renderContent()}</div>
            </div>
          </motion.div>
        </>
      )}
