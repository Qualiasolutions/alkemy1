...
import { AlertTriangleIcon, CheckIcon, InfoIcon, XIcon } from './icons/Icons'
...
const Toast: React.FC<ToastProps> = ({ toast, onClose }) => {
  ...
  const styles = {
    success:
      'bg-gradient-to-r from-green-950/98 via-green-900/98 to-yellow-900/98 border-green-500/60 text-green-100 shadow-[0_8px_32px_rgba(223,236,45,0.3)]',
    error:
      'bg-gradient-to-r from-red-950/98 via-red-900/98 to-rose-900/98 border-red-500/60 text-red-100 shadow-[0_8px_32px_rgba(239,68,68,0.3)]',
    warning:
      'bg-gradient-to-r from-yellow-950/98 via-yellow-900/98 to-amber-900/98 border-yellow-500/60 text-yellow-100 shadow-[0_8px_32px_rgba(223,236,45,0.3)]',
