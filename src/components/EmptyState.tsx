...
import { ClapperboardIcon, FilmIcon, ScriptIcon, SparklesIcon } from './icons/Icons'
    ...
    switch (type) {
      case 'script':
        return {
          ...
          description:
            description ||
            'Upload or paste your screenplay to begin. Alkemy will analyze it and break it down into production-ready scenes with character, location, and shot information.',
          actionLabel: actionLabel || 'Upload Script',
          illustrationColor: isDark
            ? 'from-[var(--color-accent-primary)]/20 to-[var(--color-accent-primary)]/10'
            : 'from-[var(--color-accent-primary)]/30 to-[var(--color-accent-primary)]/20',
        }
      case 'moodboard':
        return {
          ...
          description:
            description ||
            'Add reference images, color palettes, and cinematography notes to guide your AI-generated content. A strong moodboard ensures consistent visual quality across all shots.',
          actionLabel: actionLabel || 'Add Reference Image',
          illustrationColor: isDark
            ? 'from-purple-500/20 to-pink-600/10'
            : 'from-purple-500/30 to-pink-600/20',
        }
      case 'characters':
        return {
          ...
          description:
            description ||
            'Generate character portraits based on your script analysis. These will be used as reference for shot generation to maintain visual consistency.',
          actionLabel: actionLabel || 'Generate Characters',
          illustrationColor: isDark
            ? 'from-[var(--color-accent-primary)]/20 to-[var(--color-accent-secondary)]/10'
            : 'from-[var(--color-accent-primary)]/30 to-[var(--color-accent-secondary)]/20',
        }
      case 'shots':
        return {
          ...
          description:
            description ||
            'Generate cinematic stills and videos for each scene. Alkemy will create professional shots with proper framing, lighting, and composition based on your script.',
      ...
      case 'timeline':
        return {
          ...
          description:
            description ||
            'Transfer your upscaled video shots to the timeline to assemble your final production. You can trim, reorder, and export your complete video sequence.',
    ...
    >
      <div className="max-w-2xl w-full text-center">
        ...
        >
          ...
          <p
            className={`text-lg mb-8 leading-relaxed ${isDark ? 'text-gray-400' : 'text-gray-600'}`}
          >
            {content.description}
          </p>
          ...
          {(onAction || onSecondaryAction) && (
            ...
            >
              {onAction && (
                <Button onClick={onAction} variant="primary" className="!px-6 !py-3">
                  {content.actionLabel}
                </Button>
              )}
              {onSecondaryAction && secondaryActionLabel && (
                <Button onClick={onSecondaryAction} variant="secondary" className="!px-6 !py-3">
                  {secondaryActionLabel}
                </Button>
              )}
            </motion.div>
