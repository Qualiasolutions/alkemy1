        ...
        <div className="absolute bottom-4 left-4 flex gap-2">
          {(['orbit', 'fly', 'locked'] as const).map((mode) => (
            <button
              ...
              style={{
                backgroundColor:
                  cameraMode === mode ? colors.accent_primary : `${colors.bg_secondary}CC`,
                color: cameraMode === mode ? colors.bg_primary : colors.text_primary,
          ...
          >
            ...
            <div className="mt-3 pt-3 border-t" style={{ borderColor: colors.border }}>
              <p style={{ color: colors.text_tertiary }} className="text-xs">
                ...
                <br />• Left click + drag to orbit
                <br />• Right click + drag to pan
                <br />• Scroll to zoom
                <br />• W/A/S/D to move (Fly mode)
              </p>
            </div>
          </motion.div>
        )}
