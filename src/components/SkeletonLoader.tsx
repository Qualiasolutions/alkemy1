...
export const SkeletonCard: React.FC = () => {
  ...
  return (
    <div
      className={`${isDark ? 'bg-gray-900 border-gray-800' : 'bg-white border-gray-200'} border rounded-xl p-4`}
    >
...
export const SkeletonTimelineClip: React.FC = () => {
  ...
  return (
    <div
      className={`${isDark ? 'bg-gray-900 border-gray-800' : 'bg-white border-gray-200'} border rounded-lg p-3 flex items-center gap-3`}
    >
