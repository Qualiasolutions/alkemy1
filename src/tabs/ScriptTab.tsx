                ...
                <div className="absolute inset-0 pointer-events-none">
                    ...
                    <motion.div
                        ...
                        className={`absolute bottom-1/4 right-1/3 w-[450px] h-[450px] rounded-full blur-3xl ${
                            isDark ? 'bg-gradient-to-tl from-[#DFEC2D]/15 to-[#FDE047]/8' : 'bg-gradient-to-tl from-[#DFEC2D]/20 to-[#FDE047]/12'
                        }`}
                    />
                    <motion.div
                        animate={{
                                ...
                                >
                                    <motion.div
                                        ...
                                        className={`w-20 h-20 mb-6 ${
                                            isDark ? 'text-[#DFEC2D]' : 'text-[#FDE047]'
                                        }`}
                                    >
                                        <UploadCloudIcon />
                                    </motion.div>
                            ...
                            >
                                ...
                                <button
                                    ...
                                    className={`font-semibold ${
                                        isDark ? 'text-[#DFEC2D] hover:text-[#FEF08A]' : 'text-[#FDE047] hover:text-[#b3c216]'
                    ...
                    {analysis && (
                        ...
                        >
                            <div className="text-center">
                                <div className={`text-2xl font-bold ${isDark ? 'text-[#DFEC2D]' : 'text-[#FDE047]'}`}>
